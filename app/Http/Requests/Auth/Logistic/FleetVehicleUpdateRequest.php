...
class FleetVehicleUpdateRequest extends FormRequest
{
    /**
    ...
    {
        $rules = [
            'license_plate' => 'required|string|max:15|min:1|unique:fleet_vehicles,license_plate,' . $this->license_plate . ',license_plate',
    ...
    public function messages()
    {
        return [
            ...
            'license_plate.required' => 'Trường :attribute là bắt buộc',
