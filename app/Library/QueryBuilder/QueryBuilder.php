...
class QueryBuilder
{
    ...
    protected function addFunctionToCallWhenGet($key, $fun)
    {
        $this->funcCalls[$key] = $fun;
    }
    public function get()
    {
    ...
    {
        if (!empty($this->funcCalls)) {
            if (isset($this->funcCalls['aggrid'])) {
                $this->funcCalls['aggrid']();
                unset($this->funcCalls['aggrid']);
            }
            foreach ($this->funcCalls as $fun) {
                if (is_callable($fun)) {
                    $fun();
                }
            }
