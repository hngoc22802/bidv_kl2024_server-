...
trait AddSearchToQuery
{
    public function allowedSearch($fields): self
    {
        ...
        $this->addFunctionToCallWhenGet('search', function () use ($fields) {
    ...
    protected function addSearchValueToQuery($fields, $value)
    {
        ...
        $prependedFields = !empty($modelTableName) ? $this->prependFieldsWithTableName(collect($fields), $modelTableName) : collect($fields);
